      ...
      /*'user' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'POST registration' => 'reg/create',
                'GET client' => 'client/account',
                'GET services' => 'service/show',
                'GET register'=> 'reg/show',
                'PATCH client' => 'client/edit',
                'GET cladmin'=> 'client/admin',
                'DELETE service/<id>'=>'service/delete',
                'DELETE register/<id>'=>'reg/delete',
            ],
        ],
